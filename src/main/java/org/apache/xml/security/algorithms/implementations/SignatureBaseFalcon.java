...
public abstract class SignatureBaseFalcon extends SignatureAlgorithmSpi {
     ...
     */
    public SignatureBaseFalcon() throws XMLSignatureException {
        this(null);
    }
    ...
    protected void engineInitSign(
        ...
        throw new XMLSignatureException("algorithms.CannotUseAlgorithmParameterSpecOnFalcon");
    }

    public static class SignatureFalcon extends SignatureBaseFalcon {
        /**
         * Constructor SignatureDilithium
         *
         * @throws XMLSignatureException
         */
        public SignatureFalcon() throws XMLSignatureException {
            super();
        }

        public SignatureFalcon(Provider provider) throws XMLSignatureException {
            super(provider);
        }
        ...
        public String engineGetURI() {
            return XMLSignature.ALGO_ID_SIGNATURE_FALCON;
        }
    }
}